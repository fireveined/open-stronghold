...
let WandererComp = class WandererComp extends perform_ecs_1.Component {
    reset(obj, wanderingDuration, idleDuration, priority) {
...
WandererComp = __decorate([
    perform_ecs_1.makeComponent
], WandererComp);
exports.WandererComp = WandererComp;
